...
def mainMenu():
    ...
    bg = pygame.image.load('Images/MMs.jpg')
    bg = pygame.transform.scale(bg, (1600, 900))

    playImg = pygame.image.load('Images/PlayButton.png')
    settingsImg = pygame.image.load('Images/SettingsButton.png')
    creditsImg = pygame.image.load('Images/Credits.png')
    helpImg = pygame.image.load('Images/qMark.png')
    tGray = pygame.image.load('Images/TranslucentGray.png')
